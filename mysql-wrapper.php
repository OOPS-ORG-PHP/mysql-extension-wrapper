...
if ( ! function_exists ('mysql_connect') ) {
	...
	// {{{ +-- public (string) mysql_field_table ($result, $offset)
	/**
	...
	// {{{ +-- public (string) mysql_field_type ($result, $offset)
	/**
	...
	// {{{ +-- public (bool) mysql_free_result ($result)
	/**
	 * Free result memory
	...
	// {{{ +-- public (string) mysql_get_client_info (void)
	/**
	...
	// {{{ +-- public (string) mysql_get_host_info ($c = null)
	/**
	 * Get MySQL host info
	...
	// {{{ +-- public (int) mysql_get_proto_info ($c = null)
	/**
	...
	// {{{ +-- public (string) mysql_get_server_info ($c = null)
	/**
	...
	// {{{ +-- public (string) mysql_info ($c = null)
	/**
	...
	// {{{ +-- public (int) mysql_insert_id ($c = null)
	/**
	...
	// {{{ +-- public (resource) mysql_list_dbs ($c = null)
	/**
	...
	// {{{ +-- public (resource) mysql_list_fields ($db, $table, $c = null)
	/**
	...
	// {{{ +-- public (resource) mysql_list_processes ($c = null)
	/**
	...
	// {{{ +-- public (resource) mysql_list_tables ($database, $c = null)
	/**
	...
	// {{{ +-- public (int) mysql_num_fields ($result)
	/**
	...
	// {{{ +-- public (int) mysql_num_rows ($result)
	/**
	...
	// {{{ +-- public (resource) mysql_pconnect ($host = null, $user = null, $pass = null, $link = false, $flag = 0)
	/**
	...
	// {{{ +-- public (resource) mysql_query ($query, $c = null)
	/**
	 * Send a MySQL query
	...
	if ( ! function_exists ('mysql_real_escape_string') ) {
		// {{{ +-- public (string) mysql_real_escape_string ($escape, $c = null)
		/**
	...
	// {{{ +-- public (string) mysql_result ($result, $row, $field = 0)
	/**
	 * Get result data
	...
	// {{{ +-- public (bool) mysql_select_db ($db, $c = null)
	/**
	...
	// {{{ +-- public (bool) mysql_set_charset ($charset, $c = null)
	/**
	...
	// {{{ +-- public (string) mysql_stat ($c = null)
	/**
	...
	// {{{ +-- public (string) mysql_tablename ($result, $offset)
	/**
	...
	// {{{ +-- public (int) mysql_thread_id ($c = null)
	/**
	...
	// {{{ +-- public (resource) mysql_unbuffered_query ($query, $c = null)
	/**
	...
	// {{{ +-- public (null|void) mysql_get_current_database ($c = null)
	/**
	 * @param null $c
	 * @return null|void
	 */
	...
	// {{{ +-- public (bool|object) mysqli_mysqli_fetch_field_direct ($result, $offset)
	/**
	 * @param $result
	 * @param $offset
	 * @return bool|object
	...
	// {{{ +-- public (mixed|null) mysql_global_resource (&$c, $argc, $noerr = false)
	/**
	 * @param $c
	 * @param $argc
	 * @param bool $noerr
	...
	// {{{ +-- public (string) mysql_trigger_msg ($msg, $tr)
	/**
	 * @param $msg
	 * @param $tr
	 * @return string
